 ...
 */
final class Version20260301143652 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // admin.nom and admin.prenom were already added by an earlier migration; skip here
        // (left intentionally blank to maintain generated structure)
        ...
        // producteur table modifications already handled in an earlier migration; skipping here to avoid duplicate columns/indexes
        // (previous migration added agree_terms and removed is_verified)
        // no action required for producteur in this step
        ...
        // copy old users providing a safe default for agree_terms
